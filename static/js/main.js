document.addEventListener('DOMContentLoaded', () => {
  ...
  function renderVehicleDetails(vehicles) {
    ...
    vehicles.forEach(vehicle => {
      ...
      html += `
        <tr>
          <td data-label="Slot No."><strong>${vehicle.slot_number}</strong></td>
          <td data-label="License Plate"><span class="plate-badge">${vehicle.plate}</span></td>
          <td data-label="Entry Time">${vehicle.time_in}</td>
          <td data-label="Exit Time">${vehicle.time_out}</td>
          <td data-label="Duration (min)">${vehicle.duration_minutes}</td>
          <td data-label="Charge"><strong>${vehicle.charge}</strong></td>
          <td data-label="Status"><span class="status-badge ${statusClass}">${vehicle.status}</span></td>
          <td data-label="Payment Status"><span class="payment-badge ${paymentClass}">${paymentText}</span></td>
        ...
        <div class="slip-container">
          ...
          <div class="slip-body">
            ...
            <div class="slip-row">
              ...
              <span class="slip-value">${slotNumber}</span>
            </div>
