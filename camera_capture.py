...
IP_WEBCAM_URL = "http://10.211.8.191:8080/video"  # Update this IP address
...
def _worker_process(q: queue.Queue, stop_event: threading.Event):
    ...
    while not stop_event.is_set():
        ...
        # Notify user screen immediately
        try:
            requests.post('http://localhost:5000/api/notify-detection', data={'plate': plate}, timeout=1)
        except:
            pass
